...
Item {
        ...
        StackLayout {
                ...
                RowLayout {
                    ...
                    RowLayout {
                        ...
                        SmallIconButton {
                            ...
                            // ToolTip.text: timerView.isPaused ? qsTr("Resume") : qsTr("Pause")
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    // ToolTip.timeout: 3000
                    // ToolTip.delay: 300
                    // ToolTip.visible: idleView.tab === 1 && timeMouseArea.containsMouse
                    // // ToolTip.text: qsTr("Weather")
                    // ToolTip.text: idleView.tab === 1 ? qsTr("Scroll to adjust") : ""
    ...
    component WeatherStat: Item {
        ...
        // ToolTip.timeout: 3000
        // ToolTip.delay: 300
        // ToolTip.visible: statHover.containsMouse && tip !== ""
        // ToolTip.text: tip
    }
