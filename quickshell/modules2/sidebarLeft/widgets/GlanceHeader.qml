...
Item {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            StyledText {
                text: Qt.formatTime(DateTime.clock.date, "h:mm A")
            ...
            Row {
                ...
                RippleButton {
                    ...
                    // ToolTip.delay: 300
                    // ToolTip.visible: hovered
                    // ToolTip.text: qsTr("Do not disturb is on")
                ...
                Item {
                    ...
                    RippleButton {
                        ...
                        // ToolTip.delay: 300
                        // ToolTip.visible: hovered
                        // ToolTip.text: Audio.sink?.audio?.muted ? qsTr("Unmute") : qsTr("Scroll to adjust volume")
                ...
                RippleButton {
                    ...
                    // ToolTip.delay: 300
                    // ToolTip.visible: hovered
                    // ToolTip.text: qsTr("Manage Widgets")
                }
            }
        }
