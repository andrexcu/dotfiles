...
Row {
    ...
    property color colour: type == SplitButton.Filled ? colorsPalette.primary : colorsPalette.secondaryContainer
    property color textColour: type == SplitButton.Filled ? colorsPalette.primary : colorsPalette.m3onSecondaryContainer
    property color disabledColour: Qt.alpha(colorsPalette.surface, 0.1)
    property color disabledTextColour: Qt.alpha(colorsPalette.surface, 0.38)
