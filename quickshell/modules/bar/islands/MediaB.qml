...
Rectangle {
    ...
    readonly property string cleanedTitle: StringUtils.cleanMusicTitle(activePlayer?.trackTitle || activePlayer?.metadata?.title) 
...
// Volume popup
    ...
    WaveVisualizer {
        ...
        z: 1 // Make sure it's behind other content
    }
    RowLayout {
