...
//     readonly property real r: hexItem._r
//     readonly property real cx: hexItem._cx
//     readonly property real cy: hexItem._cy
//     readonly property real cos30: hexItem._cos30
//     readonly property real sin30: hexItem._sin30

//     property point p0: Qt.point(cx + r,             cy)
//     property point p1: Qt.point(cx + r * sin30,     cy - r * cos30)
//     property point p2: Qt.point(cx - r * sin30,     cy - r * cos30)
//     property point p3: Qt.point(cx - r,             cy)
//     property point p4: Qt.point(cx - r * sin30,     cy + r * cos30)
//     property point p5: Qt.point(cx + r * sin30,     cy + r * cos30)
...
//     PathMove {
//         x: selectedHexBorder.p0.x
//         y: selectedHexBorder.p0.y
//     }

//     PathLine {
//         x: selectedHexBorder.lerp(
//                selectedHexBorder.p0.x,
//                selectedHexBorder.p1.x,
//                selectedHexBorder.t
//            )

//         y: selectedHexBorder.lerp(
//                selectedHexBorder.p0.y,
//                selectedHexBorder.p1.y,
//                selectedHexBorder.t
//            )
//     }
// }
...
//         x: selectedHexBorder.lerp(
//                selectedHexBorder.p0.x,
//                selectedHexBorder.p5.x,
//                selectedHexBorder.t
//            )

//         y: selectedHexBorder.lerp(
//                selectedHexBorder.p0.y,
//                selectedHexBorder.p5.y,
//                selectedHexBorder.t
//            )
//     }
// }
...
//     PathMove {
//         x: selectedHexBorder.p3.x
//         y: selectedHexBorder.p3.y
//     }

//     PathLine {
//         x: selectedHexBorder.lerp(
//                selectedHexBorder.p3.x,
//                selectedHexBorder.p2.x,
//                selectedHexBorder.t
//            )

//         y: selectedHexBorder.lerp(
//                selectedHexBorder.p3.y,
//                selectedHexBorder.p2.y,
//                selectedHexBorder.t
//            )
//     }
// }
...
//         x: selectedHexBorder.lerp(
//                selectedHexBorder.p3.x,
//                selectedHexBorder.p4.x,
//                selectedHexBorder.t
//            )

//         y: selectedHexBorder.lerp(
//                selectedHexBorder.p3.y,
//                selectedHexBorder.p4.y,
//                selectedHexBorder.t
//            )
//     }
// }
...
//     PathMove {
//         x: selectedHexBorder.p2.x
//         y: selectedHexBorder.p2.y
//     }
...
//     PathMove {
//         x: selectedHexBorder.p4.x
//         y: selectedHexBorder.p4.y
//     }
...
// }
  ...
  Item {
    ...
    (itemData && itemData.filePath)
        ? WallpaperCacheService.thumbnailPaths[itemData.filePath] || ""
        : ""
    ...
    Canvas {
        ...
        // readonly property real _cx: _r
        // readonly property real _cy: container.cellHeight / 2
        // readonly property real _cos30: 0.866025
        // readonly property real _sin30: 0.5
        // HORIZONTAL HEX
