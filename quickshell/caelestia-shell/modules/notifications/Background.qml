...
ShapePath {
    ...
    // }
    PathArc {
        relativeX: root.wrapper.height > 0 ? root.rounding : 0
        relativeY: root.wrapper.height > 0 ? root.rounding : 0
        radiusX: root.wrapper.height > 0 ? root.rounding : 0
        radiusY: root.wrapper.height > 0 ? root.rounding : 0
    }
