    ...
    Grid {
        ...
        Repeater {
            ...
            Rectangle {
                ...
                // --- neighbor occupancy ---
                property bool previousOccupied: Boolean(workspaceOccupied[index-1]) && !(Boolean(activeWindow?.activated) === false && monitor?.activeWorkspace?.id === index)
                property bool nextOccupied: Boolean(workspaceOccupied[index+1]) && !(Boolean(activeWindow?.activated) === false && monitor?.activeWorkspace?.id === index+2)
