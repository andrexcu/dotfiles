...
Item {
    ...
    property real topBarHeight: 20 // hardcoded for testing
    ...
    implicitHeight: {
        ...
        return Math.min(
            (QsWindow.window?.screen?.height ?? 0) - topBarHeight - Config.border.thickness * 2,
            height + padding * 2
        );
    }
    ...
    ClippingWrapperRectangle {
        anchors.top: parent.top
        anchors.topMargin: topBarHeight + root.padding     // top margin based on top bar
        anchors.left: parent.left
        anchors.leftMargin: root.padding                   // left margin
        anchors.right: parent.right
        anchors.rightMargin: root.padding                  // optional right margin
        anchors.bottom: parent.bottom
