...
// r   readonly property real topBarHeight: barWrapper.content.item ? barWrapper.content.item.implicitHeight : 0
    readonly property real topBarHeight: barWrapper.content.item ? barWrapper.content.item.implicitHeight : 0
    // readonly property real topBarHeight: {
    //     if (barWrapper.content.item)
    //         return barWrapper.content.item.implicitHeight
    //     else
    //         return 0
    // }
    anchors.fill: parent
